...
<body class="seo_version">
    ...
    <div id="home" class="parallax first-section" data-stellar-background-ratio="0.4" style="background-image:url('uploads/h2.jpg');">
        <div class="container">
            <div class="row">
                ...
                <div class="app_iphone_02 wow slideInUp hidden-xs hidden-sm" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="uploads/married.png" alt="" class="img-responsive">
                </div>
            </div>
        </div>
    </div>
