    ...
    <div id="support" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Selamat datang di halaman Register SiapNikah.com<br>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="contact_form">
                        <div id="message"></div>
                        <form  action="<?= site_url('user/register') ?>" class="row" name="contactform" method="post">
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" name="confim-password" id="confirm-password" class="form-control" placeholder="Password">
                                </div>
    ...
    <svg id="clouds1" class="hidden-xs" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100" viewBox="0 0 85 100" preserveAspectRatio="none">
        ...
        $(function () {
            $("#btnSubmit").click(function () {
                ...
                var confirmPassword = $("#confim-password").val();
