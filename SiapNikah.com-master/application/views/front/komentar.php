            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right menu-top">
                      ...
                      <li><a class="active" href="<?php echo site_url("welcome/komentar")?>">Komentar & Saran</a></li>
            ...
            <div class="container">
                <div class="inner-container">
                    <ul class="bread-crumb">
                        <li><a href="<?php echo base_url(); ?>">Home</a></li>
                        <li><span>Komentar & Saran</span></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="support" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Kami Menerima Saran & Komentar dari Anda<br>
                Saran & Komentar anda sangat berharga bagi kami</p>
            </div><!-- end title -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="contact_form">
                        ...
                        <form  class="row" action="<?= site_url('welcome/insert_komentar') ?>" name="contactform" method="post">
                            <fieldset class="row-fluid">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                                    <input type="text" name="nama_komentar"  class="form-control" placeholder="Nama">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                                    <input type="text" name="isi_komentar"  class="form-control" placeholder="Komentar & Saran">
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
                                   <button type="reset" class="btn btn-light btn-radius btn-brd grd1 btn-block">Reset</button>
                                </div>
                            </fieldset>
