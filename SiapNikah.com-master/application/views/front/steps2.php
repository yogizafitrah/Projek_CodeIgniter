        ...
        <div class="container">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                    <td>
                        <?php echo $row['id_tahap2']; ?>
                    </td>
                    <td>
                        <?php echo $row['isi_tahap2']; ?>
                    </td>     
                </tr>
                
                <?php } ?>
                <tr>
                    <td colspan="2" ><div class="submit"><a href="<?php echo site_url("welcome/step3")?>" onClick="return confirm('Apakah anda sudah menyelesaikan semua list persiapan ?')"><button type="submit" id="stepsubmit"><img src="<?php echo base_url(); ?>assets/uploads/ceklis.png" width="20" height="20"></button></a></div></td>
                </tr>
              </tbody>
            </table>
            </div><!-- end row -->
