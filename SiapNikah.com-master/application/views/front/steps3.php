    ...
    <div id="services" class="section wb">
        <div class="container">
            ...
            <table>
              <thead>
                <tr>
                  <th colspan="3">2-3 Bulan Sebelum Hari-H</th>
                </tr>
                <tr>
                    <td>
                        No
              ...
              <tbody>
                ...
                <tr>
                    <td>
                        <?php echo $row['id_tahap3']; ?>
                    </td>
                    <td>
                        <?php echo $row['isi_tahap3']; ?>
                    </td>   
                </tr>
                
                <?php } ?>
                <tr>
                    <td colspan="2" ><div class="submit"><a href="<?php echo site_url("welcome/step4")?>" onClick="return confirm('Apakah anda sudah menyelesaikan semua list persiapan ?')"><button type="submit" id="stepsubmit"><img src="<?php echo base_url(); ?>assets/uploads/ceklis.png" width="20" height="20"></button></a></div></td>
                </tr>
              </tbody>
            </table>
            </div><!-- end row -->
